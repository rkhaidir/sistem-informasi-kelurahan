<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="{{ Request::is('admin/home') ? 'active' : '' }}"><a class="nav-link" href="blank.html"><i class="fa-solid fa-fire"></i><span>{{ __('Beranda') }}</span></a></li>
      ...
      <li class="dropdown {{ Request::is('admin/wilayah*') ? 'active' : '' }}">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a class="nav-link" href="layout-transparent.html">RT</a></li>
        </ul>
      </li>
      <li class="dropdown">
